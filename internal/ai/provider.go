...
type ChatRequest struct {
	...
	MaxTokens   int
	Temperature float64
	// ContextLimit limits the number of messages sent (0 = no limit, default 50)
	ContextLimit int
	// QwenLargeContextEnabled enables 256k context window for Qwen (default false)
	QwenLargeContextEnabled bool
}
